...
namespace TurbKineticEnergyTAMSSSTSrcElemKernel {
...
namespace SpecificDissipationRateTAMSSSTSrcElemKernel {
...
TEST_F(TAMSKernelHex8Mesh, NGP_turb_kinetic_energy_tams_sst_src_elem)
{
  ...
  std::unique_ptr<sierra::nalu::Kernel> kernel(
    new sierra::nalu::TurbKineticEnergyTAMSSSTSrcElemKernel<
  ...
  namespace gold_values = hex8_golds::TurbKineticEnergyTAMSSSTSrcElemKernel;
...
TEST_F(TAMSKernelHex8Mesh, NGP_specific_dissipation_rate_tams_sst_src_elem)
{
  ...
  // Initialize the kernel
  std::unique_ptr<sierra::nalu::Kernel> kernel(
    new sierra::nalu::SpecificDissipationRateTAMSSSTSrcElemKernel<
      sierra::nalu::AlgTraitsHex8>(
      bulk_, solnOpts_, helperObjs.assembleElemSolverAlg->dataNeededByKernels_,
      false));
  ...
  namespace gold_values = hex8_golds::SpecificDissipationRateTAMSSSTSrcElemKernel;
  unit_test_kernel_utils::expect_all_near(
    helperObjs.linsys->rhs_, gold_values::rhs);
  unit_test_kernel_utils::expect_all_near<8>(
    helperObjs.linsys->lhs_, gold_values::lhs);
