...
// Class Definition
//==========================================================================
// TurbViscChienKEpsAlgorithm - compute tvisc for Chien K-epsilon model
//==========================================================================
//--------------------------------------------------------------------------
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
TurbViscChienKEpsAlgorithm::TurbViscChienKEpsAlgorithm(
...
//--------------------------------------------------------------------------
void
TurbViscChienKEpsAlgorithm::execute()
{
  ...
  for (stk::mesh::BucketVector::const_iterator ib = node_buckets.begin();
    ...
    for (stk::mesh::Bucket::size_type k = 0; k < length; ++k) {
      ...
      tvisc[k] =
        cMu_ * fMu * rho[k] * tke[k] * tke[k] / std::max(tdr[k], 1.0e-16);
    }
  }
}
