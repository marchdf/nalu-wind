...
MomentumTAMSKEpsDiffEdgeKernel::MomentumTAMSKEpsDiffEdgeKernel(
  const stk::mesh::BulkData& bulk, const SolutionOptions& solnOpts)
  : NGPEdgeKernel<MomentumTAMSKEpsDiffEdgeKernel>(),
...
void
MomentumTAMSKEpsDiffEdgeKernel::setup(Realm& realm)
{
