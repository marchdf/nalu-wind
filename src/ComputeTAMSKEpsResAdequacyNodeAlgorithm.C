...
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
ComputeTAMSKEpsResAdequacyNodeAlgorithm::
...
//--------------------------------------------------------------------------
void
ComputeTAMSKEpsResAdequacyNodeAlgorithm::execute()
{
  ...
  for (stk::mesh::BucketVector::const_iterator ib = node_buckets.begin();
    ...
    for (stk::mesh::Bucket::size_type k = 0; k < length; ++k) {
      ...
      // PM[0][0] << " " << PM[0][1] << " " << PM[0][2] << " " << PM[1][0] << "
      // "
      // << PM[1][1] << " " << PM[1][2] << " " << PM[2][0] << " " << PM[2][1] <<
      // " " << PM[2][2] << " " << Mij[0][0] << " " << Mij[1][1] << " " <<
      // Mij[2][2] << " " << Mij[1][2] << std::endl;
