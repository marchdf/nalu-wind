...
SDRTAMSSSTNodeKernel::SDRTAMSSSTNodeKernel(const stk::mesh::MetaData& meta, const std::string coordsName)
  : NGPNodeKernel<SDRTAMSSSTNodeKernel>(),
...
void
SDRTAMSSSTNodeKernel::setup(Realm& realm)
{
