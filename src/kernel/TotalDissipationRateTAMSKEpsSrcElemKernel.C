...
TotalDissipationRateTAMSKEpsSrcElemKernel<AlgTraits>::
...
template <typename AlgTraits>
void
TotalDissipationRateTAMSKEpsSrcElemKernel<AlgTraits>::execute(
...
INSTANTIATE_KERNEL(TotalDissipationRateTAMSKEpsSrcElemKernel)
