...
SpecificDissipationRateTAMSSSTSrcElemKernel<AlgTraits>::
...
template <typename AlgTraits>
SpecificDissipationRateTAMSSSTSrcElemKernel<
  AlgTraits>::~SpecificDissipationRateTAMSSSTSrcElemKernel()
{
}

template <typename AlgTraits>
void
SpecificDissipationRateTAMSSSTSrcElemKernel<AlgTraits>::execute(
...
INSTANTIATE_KERNEL(SpecificDissipationRateTAMSSSTSrcElemKernel)
