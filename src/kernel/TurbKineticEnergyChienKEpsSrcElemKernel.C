...
TurbKineticEnergyChienKEpsSrcElemKernel<AlgTraits>::
...
template <typename AlgTraits>
TurbKineticEnergyChienKEpsSrcElemKernel<
  AlgTraits>::~TurbKineticEnergyChienKEpsSrcElemKernel()
{
}

template <typename AlgTraits>
void
TurbKineticEnergyChienKEpsSrcElemKernel<AlgTraits>::execute(
...
INSTANTIATE_KERNEL(TurbKineticEnergyChienKEpsSrcElemKernel)
