...
TotalDissipationRateChienKEpsSrcElemKernel<AlgTraits>::
...
template <typename AlgTraits>
TotalDissipationRateChienKEpsSrcElemKernel<
  AlgTraits>::~TotalDissipationRateChienKEpsSrcElemKernel()
{
}

template <typename AlgTraits>
void
TotalDissipationRateChienKEpsSrcElemKernel<AlgTraits>::execute(
...
INSTANTIATE_KERNEL(TotalDissipationRateChienKEpsSrcElemKernel)
