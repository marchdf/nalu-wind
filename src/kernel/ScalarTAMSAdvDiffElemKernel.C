...
ScalarTAMSAdvDiffElemKernel<AlgTraits>::ScalarTAMSAdvDiffElemKernel(
...
template <typename AlgTraits>
void
ScalarTAMSAdvDiffElemKernel<AlgTraits>::execute(
...
INSTANTIATE_KERNEL(ScalarTAMSAdvDiffElemKernel)
