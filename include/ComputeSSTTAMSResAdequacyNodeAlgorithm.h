...
#ifndef COMPUTESSTTAMSRESADEQUACYNODEALGORITHM_H
#define COMPUTESSTTAMSRESADEQUACYNODEALGORITHM_H
...
class Realm;
class ComputeSSTTAMSResAdequacyNodeAlgorithm : public Algorithm
{
public:
  ComputeSSTTAMSResAdequacyNodeAlgorithm(Realm& realm, stk::mesh::Part* part);
  virtual ~ComputeSSTTAMSResAdequacyNodeAlgorithm();
