...
#ifndef MOMENTUMTAMSSSTDIFFEDGEKERNEL_H
#define MOMENTUMTAMSSSTDIFFEDGEKERNEL_H
...
class MomentumTAMSSSTDiffEdgeKernel
  : public NGPEdgeKernel<MomentumTAMSSSTDiffEdgeKernel>
{
public:
  MomentumTAMSSSTDiffEdgeKernel(
    const stk::mesh::BulkData&, const SolutionOptions&);

  KOKKOS_FUNCTION
  MomentumTAMSSSTDiffEdgeKernel() = default;

  KOKKOS_FUNCTION
  virtual ~MomentumTAMSSSTDiffEdgeKernel() = default;
...
#endif /* MOMENTUMTAMSSSTDIFFEDGEKERNEL_H */
