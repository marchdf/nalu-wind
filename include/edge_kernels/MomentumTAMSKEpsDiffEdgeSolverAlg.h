...
#ifndef MOMENTUMTAMSKEPSDIFFEDGESOLVERALG_H
#define MOMENTUMTAMSKEPSDIFFEDGESOLVERALG_H
...
class MomentumTAMSKEpsDiffEdgeSolverAlg : public AssembleEdgeSolverAlgorithm
{
public:
  MomentumTAMSKEpsDiffEdgeSolverAlg(Realm&, stk::mesh::Part*, EquationSystem*);

  virtual ~MomentumTAMSKEpsDiffEdgeSolverAlg() = default;
...
#endif /* MOMENTUMTAMSKEPSDIFFEDGESOLVERALG_H */
