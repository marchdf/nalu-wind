...
#ifndef SDRTAMSSSTNODEKERNEL_H
#define SDRTAMSSSTNODEKERNEL_H
...
class SDRTAMSSSTNodeKernel : public NGPNodeKernel<SDRTAMSSSTNodeKernel>
{
public:
  SDRTAMSSSTNodeKernel(const stk::mesh::MetaData&, const std::string);

  KOKKOS_FUNCTION
  SDRTAMSSSTNodeKernel() = default;

  KOKKOS_FUNCTION
  virtual ~SDRTAMSSSTNodeKernel() = default;
