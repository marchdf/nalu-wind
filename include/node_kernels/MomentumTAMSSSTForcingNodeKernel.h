...
class MomentumTAMSSSTForcingNodeKernel : public NGPNodeKernel<MomentumTAMSSSTForcingNodeKernel>
{
public:
  MomentumTAMSSSTForcingNodeKernel(
    const stk::mesh::BulkData&,
    const SolutionOptions& );

  KOKKOS_FUNCTION
  MomentumTAMSSSTForcingNodeKernel() = default;

  KOKKOS_FUNCTION
  virtual ~MomentumTAMSSSTForcingNodeKernel() = default;
...
#endif /* MOMENTUMTAMSSSTFORCINGNODEKERNEL_H */
