...
#ifndef SDRSSTRCHELSTENNODEKERNEL_H
#define SDRSSTRCHELSTENNODEKERNEL_H
...
class SDRSSTRCHelstenNodeKernel : public NGPNodeKernel<SDRSSTRCHelstenNodeKernel>
{
public:
  SDRSSTRCHelstenNodeKernel(const stk::mesh::MetaData&);

  KOKKOS_FORCEINLINE_FUNCTION
  SDRSSTRCHelstenNodeKernel() = default;

  KOKKOS_FUNCTION
  virtual ~SDRSSTRCHelstenNodeKernel() = default;
...
#endif /* SDRSSTRCHELSTENNODEKERNEL_H */
