...
#ifndef TKETAMSSSTNODEKERNEL_H
#define TKETAMSSSTNODEKERNEL_H
...
class TKETAMSSSTNodeKernel : public NGPNodeKernel<TKETAMSSSTNodeKernel>
{
public:
  TKETAMSSSTNodeKernel(const stk::mesh::MetaData&, const std::string);

  KOKKOS_FUNCTION
  TKETAMSSSTNodeKernel() = default;

  KOKKOS_FUNCTION
  virtual ~TKETAMSSSTNodeKernel() = default;
