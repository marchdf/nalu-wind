...
#ifndef TDRTAMSKEPSNODEKERNEL_H
#define TDRTAMSKEPSNODEKERNEL_H
...
class TDRTAMSKEpsNodeKernel
  : public NGPNodeKernel<TDRTAMSKEpsNodeKernel>
{
public:
  TDRTAMSKEpsNodeKernel(
    const stk::mesh::BulkData&, const SolutionOptions&);

  KOKKOS_FUNCTION
  TDRTAMSKEpsNodeKernel() = default;

  KOKKOS_FUNCTION
  virtual ~TDRTAMSKEpsNodeKernel() = default;
